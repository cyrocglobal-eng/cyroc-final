            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@cyrocglobal.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+1 (678) 426-6901</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">CyRoc<br />8735 DUNWOODY PLACE #5124<br />ATLANTA, GA, 30350, USA</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
                ...
                <p className="mb-6 opacity-90">
                  Schedule a consultation with our experts to discuss your specific needs and how we can help.
                </p>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Rafaleto2015@gmail.com "
                  />
                </div>
